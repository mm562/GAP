...
<body id="overview">
   ...
   $(document).ready(function() {
      Notification.requestPermission().then((permission) => {
         if (permission === "granted") {
            $("#notification_frame").html(
               '<a href="./app.php?source=pwa"><button class="btn btn-primary">Let\'s go!</button></a>'
            );
         }
      });
   })
   ...
   <main>
      ...
      <div class="frame">
         <div class="steps highlines">
            <div class="icon-text">
               ...
               <div class="content">
                  <h4>You now use this browser-based application at least <strong>1-3 times per day</strong> for the
      ...
      <div id="notification_frame">
         <!-- <script>
         function allowNotifications() {
            Notification.requestPermission().then((permission) => {
               if (permission === "granted") {
                  $("#notification_frame").html(
                     '<h2>You\'re ready to start.</h2><a href="./app.php?source=pwa"><button class="btn btn-primary">Let\'s go!</button></a>'
                  );
               }
               if (permission !== "granted") {
         ...
         <h2>One last step:<br>
            You need to allow notifications</h2>
         <!-- <button class="btn btn-primary" onclick="allowNotifications()">Allow notifications</button> -->
      </div>
